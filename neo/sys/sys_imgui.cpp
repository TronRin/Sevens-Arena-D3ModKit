...
extern void Com_DrawSettingsMenu(); // in framework/SettingsMenu.cpp
...
namespace D3 {
	namespace ImGuiHooks {
		...
		static void UpdateWarningOverlay( void ) {
		...
		static float GetDefaultDPI( void ) {
		...
		static float GetDefaultScale( void ) {
